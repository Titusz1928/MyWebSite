...
export class ProjectService {
  private projectList:Project[]= [
    ...
    },
    {
      ...
      shortdescription:"",
      description: "This program with the help of the yolo and easyocr libraries first finds where could be a license plate be located on an image, and then reads whats on the image",
